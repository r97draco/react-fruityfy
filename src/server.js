...
app.get("", (req, res) => {
  res.send("Rav said Hello World!");
});

app.get("/fruits/", (req, res) => {
  var fruit_name = req.query.fr;
  var fruit_info = findFruit(fruit_name);
  // res.send(`Fruit data that user requested is : ${JSON.stringify(fruit_info)}`);
  res.send(fruit_info);
});
